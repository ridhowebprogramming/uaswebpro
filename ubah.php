...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Data Admin</a>
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="bidang" name="bidang">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="Teknik Listrik" <?php if ($siswa['bidang'] == 'Teknik Listrik') { ?>
                                        selected='' <?php } ?>>Teknik Listrik</option>
                                   <option value="Teknik Komputer dan Jaringan"
                                        <?php if ($siswa['bidang'] == 'Teknik Komputer dan Jaringan') { ?> selected=''
                                        <?php } ?>>Teknik Komputer dan Jaringan</option>
                                   <option value="Multimedia" <?php if ($siswa['bidang'] == 'Multimedia') { ?>
                                        selected='' <?php } ?>>Multimedia</option>
                                   <option value="Rekayasa Perangkat Lunak"
                                        <?php if ($siswa['bidang'] == 'Rekayasa Perangkat Lunak') { ?> selected=''
                                        <?php } ?>>Rekayasa Perangkat Lunak</option>
                                   <option value="Geomatika" <?php if ($siswa['bidang'] == 'Geomatika') { ?>
                                        selected='' <?php } ?>>Geomatika</option>
                                   <option value="Mesin" <?php if ($siswa['bidang'] == 'Mesin') { ?> selected=''
                                        <?php } ?>>Mesin</option>
                              </select>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                              ...
                              <img src="img/FOTOKUH.jpg<?= $siswa['gambar']; ?>" width="50%" style="margin-bottom: 10px;">
     ...
     gsap.to('.ubah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-pencil-square"></i>Ubah Data Admin'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
