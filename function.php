...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$id','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$bidang','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', bidang = '$bidang', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE id = $id";
